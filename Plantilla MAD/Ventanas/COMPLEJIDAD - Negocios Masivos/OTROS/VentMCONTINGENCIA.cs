...
{
    public partial class VentMCONTINGENCIA : Form
    {
        public VentMCONTINGENCIA()
        {
            InitializeComponent();
        }
        ...
        private void btnPlanilla_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                range2.Value = "Número SIM";
                sheet.Columns.AutoFit();
                try
                {
                    book.SaveAs(@docsDir + "CONTINGENCIA_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx");
                    MessageBox.Show("Se guardó el archivo CONTINGENCIA_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx \n\nEn " + docsDir, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch { }
                book.Close();
                app.Quit();
