...
{
    public partial class VentMRENUNCIA : Form
    {
        public VentMRENUNCIA()
        {
            InitializeComponent();
        }
        ...
        private void btnPlanilla_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                range3.Value = "Serie que renuncia";
                sheet.Columns.AutoFit();
                try
                {
                    book.SaveAs(@docsDir + "RENUNCIA_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx");
                    MessageBox.Show("Se guardó el archivo RENUNCIA_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx \n\nEn " + docsDir, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch { }
                book.Close();
                app.Quit();
