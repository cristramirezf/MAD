...
{
    public partial class VentMCONDCOMERCIALES : Form
    {
        public VentMCONDCOMERCIALES()
        {
            InitializeComponent();
        }
        ...
        private void btnPlanilla_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    book.SaveAs(@docsDir + "CONDCOMERCIALES_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx");
                    MessageBox.Show("Se guardó el archivo CONDCOMERCIALES_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx \n\nEn " + docsDir, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch { }
                book.Close();
                app.Quit();
        ...
        private bool validacionesTexto()
        {
            ...
            if (campoInfo.TextLength == 0)
            {
                MessageBox.Show("Debe completar campo con información de requerimiento", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                campoInfo.Focus();
                return false;
            }
