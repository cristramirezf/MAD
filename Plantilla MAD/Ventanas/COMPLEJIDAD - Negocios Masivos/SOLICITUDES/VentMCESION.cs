...
{
    public partial class VentMCESION : Form
    {
        public VentMCESION()
        {
            InitializeComponent();
        ...
        private void btnPlanilla_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                range2.Value = "Cuenta destino";
                range3 = sheet.Range["C1"];
                range3.Value = "Plan";
                range4 = sheet.Range["D1"];
                range4.Value = "Serie equipo";
                sheet.Columns.AutoFit();
                try
                {
                    book.SaveAs(@docsDir + "CESION_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx");
                    MessageBox.Show("Se guardó el archivo CESION_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx \n\nEn " + docsDir, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch { }
                book.Close();
                app.Quit();
            ...
            finally
            {
                ...
                if (range4 != null) Marshal.ReleaseComObject(range3);
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (validacionesTexto())
            {
                ...
                String cabecera = "RUT cesionario: " + campoRUTcesi.Text + "\n" +
                                  "RUT cedente: " + campoRUTcede.Text + "\n" +
                                  "MMF: $" + campoMMF.Text + "\n\n";
                //fin datos cabecera
