...
{
    public partial class VentMTRASPASO : Form
    {
        public VentMTRASPASO()
        {
            InitializeComponent();
        }
        ...
        private void btnPlanilla_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                range3.Value = "Cuenta Destino";
                range4 = sheet.Range["D1"];
                range4.Value = "Serie Equipo";
                sheet.Columns.AutoFit();
                try
                {
                    book.SaveAs(@docsDir + "TRASPASO_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx");
                    MessageBox.Show("Se guardó el archivo TRASPASO_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx \n\nEn " + docsDir, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch { }
                book.Close();
                app.Quit();
