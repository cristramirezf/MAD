...
{
    public partial class VentMPORTA : Form
    {
        public VentMPORTA()
        {
            InitializeComponent();
        ...
        private void btnPlanilla_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    book.SaveAs(@docsDir + "PORTA_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx");
                    MessageBox.Show("Se guardó el archivo PORTA_MASIVO_" + DateTime.Now.ToString("HHmmss_ddMMyy") + ".xlsx \n\nEn " + docsDir, "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch { }
                book.Close();
                app.Quit();
