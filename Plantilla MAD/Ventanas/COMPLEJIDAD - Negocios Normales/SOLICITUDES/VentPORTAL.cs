...
{
    public partial class VentPORTAL : Form
    {
        public VentPORTAL()
        {
            InitializeComponent();
        ...
        private void limpiarDatosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            campoRUT.Clear();
            campoObs.Clear();
            campoNombreRRLL.Clear();
            campoRutRRLL.Clear();
            campoEmailRRLL.Clear();
            campoNombreAdm.Clear();
            campoRutAdm.Clear();
            campoEmailAdm.Clear();
        }
        //fin barra menú
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (validacionesTexto())
            {
                ...
                String cabecera = "RUT: " + campoRUT.Text + "\n\n" +
                                  "Nombre nuevo RRLL: " + campoNombreRRLL.Text + "\n" +
                                  "RUT nuevo RRLL: " + campoRutRRLL.Text + "\n" +
                                  "Email nuevo RRLL: " + campoEmailRRLL.Text + "\n" +
                                  "Nombre nuevo Administrador: " + campoNombreAdm.Text + "\n" +
                                  "RUT nuevo Administrador: " + campoRutAdm.Text + "\n" +
                                  "Email nuevo Administrador: " + campoEmailAdm.Text + "\n\n";
