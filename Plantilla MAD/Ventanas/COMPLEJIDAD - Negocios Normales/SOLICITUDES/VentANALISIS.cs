...
namespace Plantilla_MAD.Ventanas
{
    public partial class VentANALISIS : Form
    {
        ...
        private void limpiarDatosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            campoObs.Clear();
            campoFacturas.Clear();
            rdAnalisis.Checked = true;
            rdAnalisisNC.Checked = false;
            rdFraude.Checked = false;
        }
        //fin barra menú
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (validacionesTexto())
            {
                ...
                String texto = cabecera + "Facturas: \n" + campoFacturas.Text.Trim() + "\n\n" + "Requerimiento: \n" + campoObs.Text.Trim() + "\n\n" + pie;
        ...
        private void rdAnalisis_CheckedChanged(object sender, EventArgs e)
        {
            lblProy.Text = "ANALISIS";
            lblFraude.Visible = false;
            lblRuta.Text = "Solicitudes Servicios Móviles - Analisis de cliente";
        }

        private void rdAnalisisNC_CheckedChanged(object sender, EventArgs e)
        {
            lblProy.Text = "ANALISIS NC";
            lblFraude.Visible = false;
            lblRuta.Text = "Reclamos Servicios Móviles - Tarifas Incorrectas";
        }

        private void rdFraude_CheckedChanged(object sender, EventArgs e)
        {
            lblProy.Text = "FRAUDE";
            lblFraude.Visible = true;
            lblRuta.Text = "Solicitudes Servicios Móviles - Analisis de cliente";
        }

        private void VentANALISIS_Load(object sender, EventArgs e)
        {
            rdAnalisis.Checked = true;
        }
    }
