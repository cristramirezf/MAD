...
{
    public partial class VentNUEVACUENTA : Form
    {
        public VentNUEVACUENTA()
        {
            InitializeComponent();
        }
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (validacionesTexto())
            {
                ...
                String cabecera = "RUT: " + campoRUT.Text + "\n\n" +
                                  "Cuenta raíz: " + campoRaiz.Text + "\n" +
                                  "Responsable de pago: " + responsable + "\n" +
                                  "Dirección Comercial: " + campoDir.Text + "\n" +
                                  "Giro: " + campoGiro.Text + "\n\n";
