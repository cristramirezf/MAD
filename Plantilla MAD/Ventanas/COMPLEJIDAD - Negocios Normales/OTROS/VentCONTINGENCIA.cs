...
{
    public partial class VentCONTINGENCIA : Form
    {
        public VentCONTINGENCIA()
        {
            InitializeComponent();
        }
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (validacionesTexto())
            {
                ...
                {
                    if (dataDatos["SIM", i].Value != null)
                    {
                        if (dataDatos["Movil", i].Value != null)
                        {
                            datos = datos + dataDatos["Movil", i].Value.ToString() + " - " + dataDatos["SIM", i].Value.ToString() + "\n";
                        }
                    }
                }
