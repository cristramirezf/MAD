...
{
    public partial class VentNCACLARATORIA : Form
    {
        public VentNCACLARATORIA()
        {
            InitializeComponent();
        }
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            if (validacionesTexto())
            {
                ...
                for (int i = 0; i <= dataDatos.RowCount - 1; i++)
                {
                    ...
                    {
                        facturas = facturas + dataDatos["Factura", i].Value.ToString() + "\n";
                    }
                }

                datos = facturas + "\n" + 
                        "Nuevo giro: " + campoGiro.Text + "\n" +
                        "Nueva dirección: " + campoDireccion.Text + "\n" +
                        "Nueva comuna: " + campoComuna.Text + "\n" +
                        "Nueva ciudad: " + campoCiudad.Text + "\n\n";
